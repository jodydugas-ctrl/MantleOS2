...
- SCAN Engine: v0.24 frozen candidate; v0.20 remains the immutable pre-oracle cold baseline
...
- PR5 NotepadNext calibration: v0.20 cold and v0.21-v0.24 sealed reruns mechanically PASS; v0.24 covers 378/394 compiler translation units; calibration PARTIAL
...
- [`engine/v0.24/`](engine/v0.24/) — exact frozen manifest-only scanner source; this is not the NotepadNext specimen.
- [`releases/v0.24/`](releases/v0.24/) — frozen v0.24 release receipts, reproducible packaged artifacts, and completed PR5 calibration evidence. The 276 MB sealed specimen bundle is kept out of Git and identified by SHA-256.
